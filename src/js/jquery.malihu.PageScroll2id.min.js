      ...
      init: function (r) {
        ...
        l.liveSelector && (this.selector += "," + l.liveSelector),
          ...
          l.clickEvents &&
            e(a)
              .off("." + _)
              .on("click." + _, n, function (t) {
                if (O._isDisabled.call(null))
                  return void O._removeClasses.call(null);
                var a = e(this),
                  n = a.attr("href"),
                  s = a.prop("href").baseVal || a.prop("href");
                (l.excludeSelectors && a.is(l.excludeSelectors)) ||
                  (n && -1 !== n.indexOf("#/")) ||
                  (O._reset.call(null),
                  (f = a.data("ps2id-offset") || 0),
                  O._isValid.call(null, n, s) &&
                    O._findTarget.call(null, n) &&
                    (t.preventDefault(),
                    (i = "selector"),
                    (o = a),
                    O._setClasses.call(null, !0),
                    O._scrollTo.call(null)));
              }),
          e(t)
            .off("." + _)
            .on("scroll." + _ + " resize." + _, function () {
              if (O._isDisabled.call(null))
                return void O._removeClasses.call(null);
              var t = e("._" + _ + "-t");
              t.each(function (a) {
                ...
                O._setClasses.call(null, !1, n, s),
                  a == t.length - 1 && O._extendClasses.call(null);
              });
            }),
          (s = !0),
          O._setup.call(null),
      ...
      scrollTo: function (t, a) {
        ...
        if (t && "undefined" != typeof t) {
          ...
          O._reset.call(null),
            ...
            (h = a.offset),
            (t = -1 !== t.indexOf("#") ? t : "#" + t),
            O._isValid.call(null, t) &&
              O._findTarget.call(null, t) &&
              ((i = "scrollTo"),
              (o = a.clicked),
              o && O._setClasses.call(null, !0),
              O._scrollTo.call(null));
        }
      },
      destroy: function () {
    ...
    O = {
      ...
      _isValid: function (e, a) {
        if (e) {
          ...
          var n = -1 !== a.indexOf("#/") ? a.split("#/")[0] : a.split("#")[0],
            s =
              l.inIframe || t.location === t.parent.location
                ? t.location
                : t.parent.location,
          ...
          return (
            "#" !== e &&
            -1 !== e.indexOf("#") &&
            ("" === n || decodeURIComponent(n) === decodeURIComponent(i))
          );
        }
      },
      _setup: function () {
          ...
          if (O._isValid.call(null, o, r)) {
            ...
            if (u.length > 0) {
              l.highlightByNextTarget &&
                u !== s &&
                (s ? s.data(_, { tn: u }) : u.data(_, { tn: "0" }), (s = u)),
                u.hasClass("_" + _ + "-t") || u.addClass("_" + _ + "-t"),
                u.data(_, { i: n }),
                i.hasClass("_" + _ + "-h") || i.addClass("_" + _ + "-h");
              var h = O._findHighlight.call(null, c);
              O._setClasses.call(null, !1, u, h),
                (m = n),
                n++,
                n == e(t).length && O._extendClasses.call(null);
            }
          }
        });
      },
      ...
      _findTarget: function (t) {
        ...
        return (
          (r = s),
          u || (u = l.layout),
          (h = O._setOffset.call(null)),
          (c = [
            (s.offset().top - h[0]).toString(),
            (s.offset().left - h[1]).toString(),
          ]),
          (c[0] = c[0] < 0 ? 0 : c[0]),
          (c[1] = c[1] < 0 ? 0 : c[1]),
          c
      ...
      _scrollTo: function () {
        (d = O._scrollSpeed.call(null)),
          (c = l.pageEndSmoothScroll ? O._pageEndSmoothScroll.call(null) : c);
        var a = e("html,body"),
        ...
        switch (u) {
          case "horizontal":
            o != c[1] &&
              (O._callbacks.call(null, "onStart"),
              a
                .stop()
      ...
      _live: function () {
        g = setTimeout(function () {
          l.live
            ? e(O._highlightSelector()).length !== m && O._setup.call(null)
            : g && clearTimeout(g),
            O._live.call(null);
        }, 1e3);
      },
